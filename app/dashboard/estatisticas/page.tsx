...
export default function EstatisticasPage() {
  ...
  const [entradaByBrand, setEntradaByBrand] = useState<
    ...
    <>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Card className="p-4 sm:p-6">
              ...
              {entradaByBrand.length === 0 ? (
                <div className="flex h-64 flex-col items-center justify-center sm:h-80 lg:h-96">
                  ...
                  <p className="mt-1 max-w-sm text-center text-sm text-muted-foreground">
                    Não existem entradas cadastradas para {year}.
                  </p>

                  <div className="mt-4 rounded-full border bg-muted/30 px-3 py-1.5 text-xs text-muted-foreground">
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              Excluir todos os dados de {year}?
            </AlertDialogTitle>

            <AlertDialogDescription>
              Isso vai apagar <strong>permanentemente</strong> todos os
              projetos de {year} do banco de dados, junto com as pastas,
              arquivos e imagens 3D vinculados a eles. Essa ação libera espaço
              no banco, mas <strong>não pode ser desfeita</strong>.
              <br />
              <br />
